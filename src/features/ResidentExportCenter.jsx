...
export default function ResidentExportCenter({ workspace }) {
  ...
  const [filters, setFilters] = useState({ scope: "resident-one", residentId: residents[0]?.id || "", pgy: "", templateId: workspace.templates[0]?.id || "", dateFrom: "", dateTo: "" });
